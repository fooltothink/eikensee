...
const SCENARIOS = [
    ...
    },
    {
        ...
        panels: [
            { id: 'd2p1', title: 'The Closing Cafe', s: "She approached a café owner to ask for a job, but he was holding a sign that said the café was closing down.", e: "She noticed several other shops with 'FOR RENT' signs in their windows.", ex: "She felt disappointed because the local economy was struggling." },
    ...
    },
    {
        ...
        panels: [
            ...
            { id: 'd3p2', title: 'A Few Days Later', s: "While sitting in a café, he was writing down company examination dates in his diary.", e: "He looked stressed as he compared the exam dates with his university schedule.", ex: "He realized that several exams overlapped with his classes." },
    ...
    if (state.gameState === 'setup') {
        app.innerHTML = `
            <div class="bg-slate-900 p-6 text-white flex justify-between items-center">
                <div>
                    <h1 class="text-xl font-bold">🏆 SEE Voice Narrator</h1>
        ...
        app.innerHTML = `
            ...
            <div class="p-8 relative">
                ...
                <div class="min-h-[220px] flex flex-col items-center justify-center space-y-10">
                    ...
                    ${state.isCorrect ? `
                        <div class="text-green-600 font-black text-2xl animate-bounce tracking-widest">✓ CORRECT!</div>
                    ` : ''}
                </div>
